// D6: Chat UI body — extracted from app/(tabs)/chat.tsx for reuse.
// The deep-link target (app/(tabs)/chat/session/[id].tsx) uses this same
// component with an initialSessionId so the deep-link opens the right session.
...
import { useChat, type ChatMessageLocal, type UseChatReturn } from '@/hooks/use-chat';
